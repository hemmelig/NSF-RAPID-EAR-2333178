...
If you are using `uv`, you can prepare a local virtual environment with:
...
```bash
uv run pmtk data fetch raw-recordings --all
```
...
```bash
uv run lemi-ascii2mseed.py --station <STATION> --network 6D --input-dir ../../data/external/raw-recordings/2024 --output-dir ../../data/internal/2024/.
```
...
```bash
uv run lemi-ascii2mseed.py --station MOFM --network 6D --input-dir ../../data/external/raw-recordings/2025 --output-dir ../../data/internal/2025/. --pivot 2025-03-02
```
...
```bash
uv run archive-merge --input-archive ../../data/internal/2024 --output-archive ../../data/internal/archive
uv run archive-merge --input-archive ../../data/internal/2025 --output-archive ../../data/internal/archive --overwrite
```
...
```bash
uv run archive-clip --config askja-mag-clip.conf
```
